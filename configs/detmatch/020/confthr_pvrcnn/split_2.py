...
work_dir = outputs_dir + '{}/confthr_pvrcnn/split_{}'.format(pretrained_split_frac, split_num)
    ...
    ssl_cfg=dict(
        ...
        unlabeled=[
            ...
            dict(
                ...
                score_thr=0.3, 
                ssl_obj_attr='student.detector_3d', target_bboxes_key='tea.3d_bboxes_nms_stu_aug',
                target_batch_dict_key='stu'),

            dict(
                type='NumPreds',
                bboxes_key='tea.3d_bboxes_nms_stu_aug', out_name='tea'),
        ]),
